    ...
    <div className="w-full p-10 bg-gray-50 rounded-lg shadow-md">
      ...
      <div className="flex justify-between items-center mb-6 ">
        ...
        <div className="flex space-x-4 items-center">
          <BuscarBTN></BuscarBTN>
          <button className="border border-green-400 text-green-500 px-4 rounded-md flex items-center h-10 cursor-pointer" onClick={() => setModalFiltro(true)}>
          ...
          <tbody>
            {usuarios.map((usuario) => (
              <tr key={usuario.id}>
                ...
                <td className="py-3 px-4">
                  <div className="flex space-x-2 pl-2 justify-left cursor-pointer">
                ...
                <td className="py-3 px-4">
                  <button className="bg-red-500 text-white px-3 py-1 rounded-md text-sm" onClick={() => alert(`Baneando a ${usuario.Nombre}`)}>
                    Banear
                  </button>
                </td>
              </tr>
        ...
        <div className="fixed inset-0 bg-[#36363695] bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
            ...
            <form
              onSubmit={e => {
                e.preventDefault();
                // Aquí puedes aplicar los filtros a la lista de usuarios si lo deseas
